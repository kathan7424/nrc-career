...
<section 
    ...
    class="agent-reviews-block <?php echo isset($block['className']) ? $block['className'] : ''; ?>"
>
        ...
        <script>
            jQuery(document).ready(function($){
                ...
                const getListItems = () => {
                    ...
                    // setup the payload
                    let data = {
                        action: 'get_agent_reviews',
                        ppp: "<?php echo $ppp; ?>",
                        page: moreButton.getAttribute('data-page'),
                        post_type: 'agent-review'
                    }
                    $.post("<?php echo admin_url('admin-ajax.php'); ?>", data, function(response){
                        ...
                        listItems.forEach(listItem => {
                            ...
                            // add event listeners 
                            // const moreToggle = listItem.querySelector('.read-more')
                            // if (moreToggle) {
