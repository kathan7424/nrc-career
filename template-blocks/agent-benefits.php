...
<section 
    ...
    class="agent-case-studies-block <?php echo isset($block['className']) ? $block['className'] : ''; ?>"
>
            ...
            jQuery(document).ready(function($){
                ...
                const getListItems = () => {
                    ...
                    let data = {
                        ...
                        post_type: 'agent-benefit',
                        taxonomy: 'benefit-type',
                        term: "<?php echo $data['benefit_type']; ?>"
                    }
